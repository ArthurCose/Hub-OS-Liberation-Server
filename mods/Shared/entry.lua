...
local function virus_health_buff(entity)
    -- buff health to account for stronger chips
    entity:boost_max_health(40)
    entity:set_health(entity:max_health())
end

local function guardian_health_buff(entity)
