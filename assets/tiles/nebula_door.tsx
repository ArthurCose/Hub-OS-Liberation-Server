...
<tileset version="1.5" tiledversion="1.5.0" name="nebula_door" tilewidth="63" tileheight="92" tilecount="6" columns="3" objectalignment="top">
 <tileoffset x="-39" y="-76"/>
 <grid orientation="isometric" width="64" height="32"/>
 <image source="nebula_door.png" width="189" height="184"/>
 <tile id="0">
